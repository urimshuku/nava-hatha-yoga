...
const iconLinkClass =
  "inline-flex h-11 w-11 items-center justify-center rounded-full border border-border-strong text-charcoal transition-colors duration-300 ease-calm hover:bg-sand/60 hover:text-saffron focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-saffron/40";
